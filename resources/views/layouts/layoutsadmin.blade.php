...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <center>
        <img src="/pp.jpg" style="width:50%;" class="w3-round"><br><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="/admin/home" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-home fa-fw w3-margin-right"></i>HOME</a> 
    <a href="/admin/report" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-th-large fa-fw w3-margin-right"></i>MANAGE BORROW</a> 
    ...
    <a href="/admin/sport/" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-futbol-o fa-fw w3-margin-right"></i>MANAGE SPORT EQUIPMENT</a> 
    <a href="#about" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw w3-margin-right"></i>MANAGE USER</a> 
    <a href="#about" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-pencil-square-o fa-fw w3-margin-right"></i>EDIT PROFILE</a> 
